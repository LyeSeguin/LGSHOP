...
<body>
 <br>
<br>
<center> <h3> <img class="responsive-img" src="Imagens/relogio2.png" width="6%" height="20%"> Relógios <img class="responsive-img" src="Imagens/relogio2.png" width="6%" height="20%"> </h3> </center>
<!-- ESTRUTURA -->
